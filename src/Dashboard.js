...
function Dashboard({user}) {
  ...
  async function task() {
    var taskarr = await axios.get(`https://dashboard-backendd.herokuapp.com/task/${user}`,{
      headers:{
  ...
  async function attendance() {
    var attendancearr = await axios.get(`https://dashboard-backendd.herokuapp.com/attendance/${user}`,{
      headers:{
        Authorization:  window.localStorage.getItem("my_token")
      }
    });
